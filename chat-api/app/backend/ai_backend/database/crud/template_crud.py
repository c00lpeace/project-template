...
class TemplateCrud:
    ...
    def get_templates_by_pgm(self, pgm_id: str) -> List[PgmTemplate]:
        """프로그램별 템플릿 조회
    ...
    def get_templates_by_document(self, document_id: str) -> List[PgmTemplate]:
        """문서별 템플릿 조회
    ...
    def get_template_by_id(self, template_id: int) -> Optional[PgmTemplate]:
        """템플릿 ID로 조회
    ...
    def get_all_pgm_ids(self) -> List[str]:
        """모든 프로그램 ID 목록 조회
