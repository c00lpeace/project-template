...
class ProgramService:
    ...
    def create_program(
        ...
        pgm_id: str,
        pgm_name: str,
        ladder_doc_id: Optional[str] = None,
        ...
        try:
            ...
            if existing:
                raise HandledException(
                    ...
                    msg=f"프로그램 ID '{pgm_id}'는 이미 존재합니다."
                )

            program_data = {
                'pgm_id': pgm_id,
                'pgm_name': pgm_name,
                'ladder_doc_id': ladder_doc_id,
    ...
    def update_program(
        ...
        try:
            ...
            if ladder_doc_id is not None:
                update_data['ladder_doc_id'] = ladder_doc_id
            if template_doc_id is not None:
                update_data['template_doc_id'] = template_doc_id
